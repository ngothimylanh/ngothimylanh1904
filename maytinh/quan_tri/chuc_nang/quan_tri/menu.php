...
<?php
	...
	switch($menu){
		...
		case 'quan_ly_thanh_vien': include('chuc_nang/quan_tri/quan_ly_thanh_vien.php'); break;
		case 'xoa_tt_thanh_vien': include('chuc_nang/quan_tri/xoa_tt_thanh_vien.php'); break;
	}
}
else{
