...
if(isset($_POST['submit'])){
	...
	$sl= "insert into menu_doc(title,sub_1,sub_1_link,sub_2, sub_2_link,sub_3, sub_3_link,sub_4, sub_4_link) values('".$title."','".$sub_1."','".$sub_1_link."','".$sub_2."','".$sub_2_link."','".$sub_3."','".$sub_3_link."','".$sub_4."','".$sub_4_link."')";
