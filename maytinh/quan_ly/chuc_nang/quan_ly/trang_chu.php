<?php
	include('chuc_nang/quan_ly/security.php');
	if(!isset($login)){exit();}
?>
<!DOCTYPE html>
<html>
...
<div class="header col-xs-12 col-sm-12 col-md-12 col-lg-12" style="display: flex; align-items: center; justify-content: space-between;">
	...
	<div class="search col-xs-12 col-sm-8 col-md-6 col-lg-6"  style="flex: 10;">
		<form class="searchh" action="?menu=search" action="post">
			...
			<input class="form-control" type="search" name="search" placeholder="Nhập tên sản phẩm..." style="border: 0.1px solid #337ab7;">
			<button type="submit" class="form-control" name="submit" ><span class="fa fa-search"  style="border: 0.1px solid #337ab7;"></span></button>
		</form>
	</div>
