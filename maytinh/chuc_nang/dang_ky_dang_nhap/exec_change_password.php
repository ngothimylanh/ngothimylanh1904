	...
	if($num>0){
		...
		$re_password= md5($re_password);
			if($password==$re_password){
				...
				if(isset($exec)){
?>
	<p class="alert alert-success" style=" background-color: #ec522b; color: #fff;">Đổi mật khẩu thành công. Bấm <a href="?menu=thanh_vien" style="color: #337ab7;">vào đây</a> để quay lại.</p>
<?php
	}
	else{
?>
